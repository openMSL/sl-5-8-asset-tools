"""Shared test fixtures for xodr_to_geojson_caller tests."""
...
def spiral_geometry():
    ...
    from xodr_to_geojson_caller.models.geometry import Spiral
...
def param_poly3_geometry():
    ...
    from xodr_to_geojson_caller.models.geometry import ParamPoly3
