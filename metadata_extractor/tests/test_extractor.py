"""Tests for metadata_extractor.extractor – reverse-geocoding helpers."""

from unittest.mock import MagicMock, patch

from metadata_extractor.extractor import get_adress_from_osm
...
class TestStateExtraction:
    ...
    @patch("metadata_extractor.extractor.Nominatim")
