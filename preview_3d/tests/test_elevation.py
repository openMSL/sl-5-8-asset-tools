...
from preview_3d.geometry.elevation import (
    get_elevation,
    get_projected_width,
)
...
class TestGetElevation:
    def test_flat_road(self):
        ...
        h = get_elevation(
            s=10.0, t=0.0, elev_a=0.0, elev_b=0.0, elev_c=0.0, elev_d=0.0, elev_s=0.0
        )
        assert h == pytest.approx(0.0)

    def test_constant_elevation(self):
        h = get_elevation(
            s=10.0, t=0.0, elev_a=5.0, elev_b=0.0, elev_c=0.0, elev_d=0.0, elev_s=0.0
        )
    ...
    def test_linear_slope(self):
        ...
        h = get_elevation(
            s=20.0, t=0.0, elev_a=10.0, elev_b=0.05, elev_c=0.0, elev_d=0.0, elev_s=0.0
        )
    ...
    def test_elevation_with_s_offset(self):
        ...
        h = get_elevation(
            s=8.0, t=0.0, elev_a=0.0, elev_b=1.0, elev_c=0.0, elev_d=0.0, elev_s=5.0
        )
