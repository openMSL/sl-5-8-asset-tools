...
flowchart TD
    ...
    subgraph extract ["Metadata Extraction"]
        ...
        mde3d["3dmodel_metadata_extractor<br/><small>3dmodel</small>"]
    end
    ...
    subgraph geo ["Geospatial"]
        route["geojson_creator<br/><small>roadNetwork + bbox GeoJSON</small>"]
        preview["preview_3d ⚠️<br/><small>3D preview · disabled by default</small>"]
    end
